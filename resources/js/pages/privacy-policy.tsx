                ...
                <section className="relative bg-white pt-32 pb-16 lg:pt-40 lg:pb-20 overflow-hidden">
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="text-center max-w-4xl mx-auto">
                            ...
                            >
                                <Shield className="w-4 h-4 text-[#2347FA]" />
                                <span className="text-[#2347FA] font-semibold text-sm">Perlindungan Data</span>
                            </motion.div>
                                        ...
                                        <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-8 md:p-12 text-white">
                                            <div className="flex items-center mb-6">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-blue-100">Komitmen kami melindungi privasi Anda</p>
                                                </div>
                                            </div>
                                            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
                                                <p className="text-blue-50 text-sm">
                                                    <strong>Terakhir diperbarui:</strong> {new Date(privacyPolicy.updated_at).toLocaleDateString('id-ID', {
                                                        year: 'numeric',
                                                        month: 'long',
                                                        day: 'numeric'
                                                    })}
                            ...
                            >
                                <Card className="border-0 shadow-xl">
                                    <CardContent className="p-8 text-center">
                                        ...
                                        <h3 className="text-xl font-semibold text-gray-900 mb-2">Kebijakan Privasi</h3>
                                        <p className="text-gray-600">
                                            Kebijakan privasi sedang dalam proses pembaruan. Silakan hubungi kami untuk informasi lebih lanjut.
                                        </p>
                                        <div className="mt-6">
                                            <Link href="/contact">
                            ...
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-[#2347FA] to-indigo-700 text-white">
                                <CardContent className="p-8">
                                    ...
                                    <div className="space-y-2 text-blue-100">
                                        <p>Email: privacy@karirconnect.id</p>
