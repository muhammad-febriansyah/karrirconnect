...
export default function EditPointPackage({ package: pkg }: Props) {
  const [form, setForm] = useState({
    name: pkg.name,
    description: pkg.description,
    points: pkg.points.toString(),
    price: pkg.price.toString(),
    bonus_points: pkg.bonus_points.toString(),
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    router.patch(`/admin/point-packages/${pkg.id}`, cleanedForm, {
      onSuccess: () => {
    ...
    <AppLayout>
      ...
      <div className="space-y-6 p-6">
        <div className="flex flex-col gap-4">
          ...
          <h1 className="text-2xl font-bold">Edit Paket Poin - {pkg.name}</h1>
        </div>
            ...
            <div className="space-y-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="w-full"
                    onClick={() => router.get(`/admin/point-packages/${pkg.id}`)}
                  >
                    Lihat Detail
                  </Button>
              ...
              <Card>
                ...
                <CardContent className="text-sm text-gray-600 space-y-2">
                  <p><strong>ID Paket:</strong> {pkg.id}</p>
                  <p><strong>Status:</strong> {form.is_active ? 'Aktif' : 'Nonaktif'}</p>
                  <p><strong>Featured:</strong> {form.is_featured ? 'Ya' : 'Tidak'}</p>
                  
                  <div className="mt-3 pt-3 border-t">
                    <p><strong>Perhatian:</strong></p>
                    <p>• Perubahan harga tidak berlaku untuk transaksi yang sudah ada</p>
                    <p>• Menonaktifkan paket akan menghentikan penjualan</p>
                  </div>
                </CardContent>
              </Card>
            </div>
