        ...
        <AppLayout>
            ...
            <div className="space-y-6 p-6">
                <div className="flex flex-col items-start gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Edit Kategori Pekerjaan</h1>
                        <p className="mt-2 text-gray-600">Perbarui informasi kategori pekerjaan {category.name}</p>
                    </div>
                </div>
                                                ...
                                                <div className="flex items-start gap-4">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        <p className="truncate text-base font-semibold text-gray-900">
                                                            {data.image?.name || 'Gambar Kategori'}
                                                        </p>
                                                        <p className="mt-1 text-sm text-gray-500">
                                                            {data.image ? `${formatFileSize(data.image.size)} KB • ${data.image.type}` : 'Gambar saat ini'}
                                                        </p>
                                                        <div className="mt-2 flex items-center gap-1.5">
                                                            <div className="h-2 w-2 rounded-full bg-green-500"></div>
                                                            <p className="text-sm font-medium text-green-700">
                                                                {data.image ? 'Gambar baru berhasil dimuat' : 'Gambar saat ini'}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
