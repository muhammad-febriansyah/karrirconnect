...
import { GalleryVerticalEnd, LoaderCircle, Eye, EyeOff, Mail, Lock } from 'lucide-react';
                            ...
                            <form className="flex flex-col gap-6" onSubmit={submit}>
                                ...
                                <div className="grid gap-6">
                                    ...
                                    <Button
                                        ...
                                        disabled={processing}
                                        className="w-full bg-white border-2 border-gray-200 hover:border-gray-300 text-gray-700 font-semibold shadow-sm hover:shadow-md transition-all duration-300 disabled:opacity-50"
                                        style={{
                                            background: 'white',
                                ...
                                <div className="text-center text-sm text-muted-foreground space-y-2">
                                    ...
                                    <div>
                                        ...
                                        <TextLink href="/login" tabIndex={5} className="text-[#2347FA] hover:text-[#1d3af7] font-medium">
                                            Login Perusahaan
                                        </TextLink>
                                    </div>
                                </div>
